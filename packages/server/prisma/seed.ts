...
async function main() {
  ...
  await prisma.user.createMany({
    data: [
      {
        id: "ctest000000schedule000001x",
        email: "schedule@test.com",
        first_name: "Alex",
        last_name: "Schedule",
        phone: "+17776665555",
        address: "100 Calendar Ave",
        position: "Engineer",
        role: "EMPLOYEE",
    ...
    data: [
      {
        ...
        location_id: "250387",
        type: "VACATION",
        start_date: new Date("2025-06-01T00:00:00"),
        end_date: new Date("2025-06-05T00:00:00"),
        hours: 16,
        reason: "Family trip",
        status: "PENDING",
        status_priority: 1,
      },
      {
        ...
        location_id: "250387",
        type: "SICK_LEAVE",
        start_date: new Date("2025-06-10T00:00:00"),
        end_date: new Date("2025-06-11T00:00:00"),
        hours: 8,
      ...
      },
      {
        ...
        location_id: "250387",
        type: "VACATION",
        start_date: new Date("2025-07-01T00:00:00"),
        end_date: new Date("2025-07-03T00:00:00"),
        hours: 16,
      ...
      },
      {
        ...
        location_id: "250387",
        type: "VACATION",
        start_date: new Date("2025-08-01T00:00:00"),
        end_date: new Date("2025-08-03T00:00:00"),
        hours: 16,
  ...
  await prisma.shift.createMany({
    data: [
      // ── Schedule tests ──────────────────────────────────────────────────────
      {
        ...
        end_time: new Date("2025-09-01T17:00:00"),
      ...
      },
      {
        ...
        user_id: "ctest000000requester0000001",
        location_id: "250387",
        start_time: new Date("2025-09-02T09:00:00"),
        end_time: new Date("2025-09-02T17:00:00"),
      ...
      },
      {
        ...
        user_id: "ctest000000requester0000001",
        location_id: "250387",
        start_time: new Date("2025-09-03T09:00:00"),
        end_time: new Date("2025-09-03T17:00:00"),
      ...
      },
      {
        ...
        location_id: "250387",
        start_time: new Date("2025-10-02T09:00:00"),
        end_time: new Date("2025-10-02T17:00:00"),
      ...
      },
      {
        ...
        location_id: "250387",
        start_time: new Date("2025-10-03T09:00:00"),
        end_time: new Date("2025-10-03T17:00:00"),
      ...
      // ── Edit time entry tests ───────────────────────────────────────────────
      {
        ...
        user_id: "ctest000000requester0000001",
        location_id: "250387",
        start_time: new Date("2025-10-04T09:00:00"),
        end_time: new Date("2025-10-04T17:00:00"),
      ...
      },
      {
        ...
        user_id: "ctest000000requester0000001",
        location_id: "250387",
        start_time: new Date("2025-10-05T09:00:00"),
        end_time: new Date("2025-10-05T17:00:00"),
        notes: "Edit time entry - no entry",
      },
      {
        id: "cshift0000000000sched00today",
        user_id: "ctest000000schedule000001x",
        location_id: "250387",
        start_time: new Date("2026-05-11T09:00:00"),
        end_time: new Date("2026-05-11T17:00:00"),
        notes: "Schedule test - today",
      },
      // ── Upcoming (days +1 through +9) ──────────────────────────────────────
      {
        id: "cshift0000000000sched00day01",
        user_id: "ctest000000schedule000001x",
        location_id: "250387",
        start_time: new Date("2026-05-12T09:00:00"),
        end_time: new Date("2026-05-12T17:00:00"),
        notes: "Schedule test - day 1",
      },
      {
        id: "cshift0000000000sched00day02",
        user_id: "ctest000000schedule000001x",
        location_id: "250387",
        start_time: new Date("2026-05-13T09:00:00"),
        end_time: new Date("2026-05-13T17:00:00"),
        notes: "Schedule test - day 2",
      },
      {
        id: "cshift0000000000sched00day03",
        user_id: "ctest000000schedule000001x",
        location_id: "250387",
        start_time: new Date("2026-05-14T09:00:00"),
        end_time: new Date("2026-05-14T17:00:00"),
        notes: "Schedule test - day 3",
      },
      {
        id: "cshift0000000000sched00day04",
        user_id: "ctest000000schedule000001x",
        location_id: "250387",
        start_time: new Date("2026-05-15T09:00:00"),
        end_time: new Date("2026-05-15T17:00:00"),
        notes: "Schedule test - day 4",
      },
      {
        id: "cshift0000000000sched00day05",
        user_id: "ctest000000schedule000001x",
        location_id: "250387",
        start_time: new Date("2026-05-16T09:00:00"),
        end_time: new Date("2026-05-16T17:00:00"),
        notes: "Schedule test - day 5",
      },
      {
        id: "cshift0000000000sched00day06",
        user_id: "ctest000000schedule000001x",
        location_id: "250387",
        start_time: new Date("2026-05-17T09:00:00"),
        end_time: new Date("2026-05-17T17:00:00"),
        notes: "Schedule test - day 6",
      },
      {
        id: "cshift0000000000sched00day07",
        user_id: "ctest000000schedule000001x",
        location_id: "250387",
        start_time: new Date("2026-05-18T09:00:00"),
        end_time: new Date("2026-05-18T17:00:00"),
        notes: "Schedule test - day 7",
      },
      {
        id: "cshift0000000000sched00day08",
        user_id: "ctest000000schedule000001x",
        location_id: "250387",
        start_time: new Date("2026-05-19T09:00:00"),
        end_time: new Date("2026-05-19T17:00:00"),
        notes: "Schedule test - day 8",
      },
      {
        id: "cshift0000000000sched00day09",
        user_id: "ctest000000schedule000001x",
        location_id: "250387",
        start_time: new Date("2026-05-20T09:00:00"),
        end_time: new Date("2026-05-20T17:00:00"),
        notes: "Schedule test - day 9",
      },
    ],
  });
  ...
  await prisma.time_entry.createMany({
    data: [
      // requester — has01x: fully clocked out, not active
      {
        ...
        clock_in: new Date("2025-09-03T09:00:00"),
        clock_out: new Date("2025-09-03T17:00:00"),
        type: "WORK",
      },
      // requester — edittime01: fully clocked out, not active
      {
        ...
        clock_in: new Date("2025-10-04T09:00:00"),
        clock_out: new Date("2025-10-04T17:00:00"),
        type: "WORK",
      },
      // requester — clockin002x: clock_in set, no clock_out (one active entry)
      {
        ...
        clock_in: new Date("2025-10-02T09:00:00"),
        type: "WORK",
      },
